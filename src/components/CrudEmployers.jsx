...
const EmployerTable = () => {
  ...
  const [employers, setEmployers] = useState([
    { username: 'Ak005R', firstName: 'Akram', lastName: 'Lagraa', email: 'AkramGivx@yahoo.com', password: '***************' },
    { username: 'IM007aD', firstName: 'Imad', lastName: 'Habchi', email: 'imAdHOvx@gmail.com', password: '***********' },
  ]);
